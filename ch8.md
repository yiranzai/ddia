<!--ts-->
   * [第八章：分布式系统的麻烦](./ch8.md#第八章分布式系统的麻烦)
      * [故障与部分失效](./ch8.md#故障与部分失效)
         * [云计算与超级计算机](./ch8.md#云计算与超级计算机)
            * [从不可靠的组件构建可靠的系统](./ch8.md#从不可靠的组件构建可靠的系统)
      * [不可靠的网络](./ch8.md#不可靠的网络)
         * [真实世界的网络故障](./ch8.md#真实世界的网络故障)
            * [网络分区](./ch8.md#网络分区)
         * [检测故障](./ch8.md#检测故障)
         * [超时与无穷的延迟](./ch8.md#超时与无穷的延迟)
            * [网络拥塞和排队](./ch8.md#网络拥塞和排队)
         * [TCP与UDP](./ch8.md#tcp与udp)
         * [同步网络 vs 异步网络](./ch8.md#同步网络-vs-异步网络)
            * [我们不能简单地使网络延迟可预测吗？](./ch8.md#我们不能简单地使网络延迟可预测吗)
         * [延迟和资源利用](./ch8.md#延迟和资源利用)
      * [不可靠的时钟](./ch8.md#不可靠的时钟)
         * [单调钟与时钟](./ch8.md#单调钟与时钟)
            * [时钟](./ch8.md#时钟)
            * [单调钟](./ch8.md#单调钟)
         * [时钟同步与准确性](./ch8.md#时钟同步与准确性)
         * [依赖同步时钟](./ch8.md#依赖同步时钟)
            * [有序事件的时间戳](./ch8.md#有序事件的时间戳)
            * [时钟读数存在置信区间](./ch8.md#时钟读数存在置信区间)
            * [全局快照的同步时钟](./ch8.md#全局快照的同步时钟)
         * [暂停进程](./ch8.md#暂停进程)
            * [响应时间保证](./ch8.md#响应时间保证)
            * [实时是真的吗？](./ch8.md#实时是真的吗)
            * [限制垃圾收集的影响](./ch8.md#限制垃圾收集的影响)
      * [知识、真相与谎言](./ch8.md#知识真相与谎言)
         * [真理由多数所定义](./ch8.md#真理由多数所定义)
            * [领导者和锁](./ch8.md#领导者和锁)
            * [防护令牌](./ch8.md#防护令牌)
         * [拜占庭故障](./ch8.md#拜占庭故障)
         * [拜占庭将军问题](./ch8.md#拜占庭将军问题)
            * [弱谎言形式](./ch8.md#弱谎言形式)
         * [系统模型与现实](./ch8.md#系统模型与现实)
            * [算法的正确性](./ch8.md#算法的正确性)
            * [安全性和活性](./ch8.md#安全性和活性)
            * [将系统模型映射到现实世界](./ch8.md#将系统模型映射到现实世界)
      * [本章小结](./ch8.md#本章小结)
      * [参考文献](./ch8.md#参考文献)

<!-- Added by: runner, at: Tue Apr 20 03:41:34 UTC 2021 -->
