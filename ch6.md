<!--ts-->
   * [6. 分区](./ch6.md#6-分区)
      ...
      * [键值数据的分区](./ch6.md#键值数据的分区)
         * [根据键的范围分区](./ch6.md#根据键的范围分区)
         * [根据键的散列分区](./ch6.md#根据键的散列分区)
            * [一致性哈希](./ch6.md#一致性哈希)
         * [负载倾斜与消除热点](./ch6.md#负载倾斜与消除热点)
      * [分片与次级索引](./ch6.md#分片与次级索引)
         * [基于文档的二级索引进行分区](./ch6.md#基于文档的二级索引进行分区)
         * [基于关键词(Term)的二级索引进行分区](./ch6.md#基于关键词term的二级索引进行分区)
      * [分区再平衡](./ch6.md#分区再平衡)
         * [平衡策略](./ch6.md#平衡策略)
            * [反面教材：hash mod N](./ch6.md#反面教材hash-mod-n)
            * [固定数量的分区](./ch6.md#固定数量的分区)
            * [动态分区](./ch6.md#动态分区)
            * [按节点比例分区](./ch6.md#按节点比例分区)
         * [运维：手动还是自动平衡](./ch6.md#运维手动还是自动平衡)
      * [请求路由](./ch6.md#请求路由)
         * [执行并行查询](./ch6.md#执行并行查询)
      * [本章小结](./ch6.md#本章小结)
      * [参考文献](./ch6.md#参考文献)
