<!--ts-->
   * [第八章：分散式系統的麻煩](./zh-tw/ch8.md#第八章分散式系統的麻煩)
      * [故障與部分失效](./zh-tw/ch8.md#故障與部分失效)
         * [雲端計算與超級計算機](./zh-tw/ch8.md#雲端計算與超級計算機)
            * [從不可靠的元件構建可靠的系統](./zh-tw/ch8.md#從不可靠的元件構建可靠的系統)
      * [不可靠的網路](./zh-tw/ch8.md#不可靠的網路)
         * [真實世界的網路故障](./zh-tw/ch8.md#真實世界的網路故障)
            * [網路分割槽](./zh-tw/ch8.md#網路分割槽)
         * [檢測故障](./zh-tw/ch8.md#檢測故障)
         * [超時與無窮的延遲](./zh-tw/ch8.md#超時與無窮的延遲)
            * [網路擁塞和排隊](./zh-tw/ch8.md#網路擁塞和排隊)
         * [TCP與UDP](./zh-tw/ch8.md#tcp與udp)
         * [同步網路 vs 非同步網路](./zh-tw/ch8.md#同步網路-vs-非同步網路)
            * [我們不能簡單地使網路延遲可預測嗎？](./zh-tw/ch8.md#我們不能簡單地使網路延遲可預測嗎)
         * [延遲和資源利用](./zh-tw/ch8.md#延遲和資源利用)
      * [不可靠的時鐘](./zh-tw/ch8.md#不可靠的時鐘)
         * [單調鐘與時鐘](./zh-tw/ch8.md#單調鐘與時鐘)
            * [時鐘](./zh-tw/ch8.md#時鐘)
            * [單調鐘](./zh-tw/ch8.md#單調鐘)
         * [時鐘同步與準確性](./zh-tw/ch8.md#時鐘同步與準確性)
         * [依賴同步時鐘](./zh-tw/ch8.md#依賴同步時鐘)
            * [有序事件的時間戳](./zh-tw/ch8.md#有序事件的時間戳)
            * [時鐘讀數存在置信區間](./zh-tw/ch8.md#時鐘讀數存在置信區間)
            * [全域性快照的同步時鐘](./zh-tw/ch8.md#全域性快照的同步時鐘)
         * [暫停程序](./zh-tw/ch8.md#暫停程序)
            * [響應時間保證](./zh-tw/ch8.md#響應時間保證)
            * [實時是真的嗎？](./zh-tw/ch8.md#實時是真的嗎)
            * [限制垃圾收集的影響](./zh-tw/ch8.md#限制垃圾收集的影響)
      * [知識、真相與謊言](./zh-tw/ch8.md#知識真相與謊言)
         * [真理由多數所定義](./zh-tw/ch8.md#真理由多數所定義)
            * [領導者和鎖](./zh-tw/ch8.md#領導者和鎖)
            * [防護令牌](./zh-tw/ch8.md#防護令牌)
         * [拜占庭故障](./zh-tw/ch8.md#拜占庭故障)
         * [拜占庭將軍問題](./zh-tw/ch8.md#拜占庭將軍問題)
            * [弱謊言形式](./zh-tw/ch8.md#弱謊言形式)
         * [系統模型與現實](./zh-tw/ch8.md#系統模型與現實)
            * [演算法的正確性](./zh-tw/ch8.md#演算法的正確性)
            * [安全性和活性](./zh-tw/ch8.md#安全性和活性)
            * [將系統模型對映到現實世界](./zh-tw/ch8.md#將系統模型對映到現實世界)
      * [本章小結](./zh-tw/ch8.md#本章小結)
      * [參考文獻](./zh-tw/ch8.md#參考文獻)
