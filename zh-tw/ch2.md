<!--ts-->
   * [2. 資料模型與查詢語言](./zh-tw/ch2.md#2-資料模型與查詢語言)
      * [關係模型與文件模型](./zh-tw/ch2.md#關係模型與文件模型)
         * [NoSQL的誕生](./zh-tw/ch2.md#nosql的誕生)
         * [物件關係不匹配](./zh-tw/ch2.md#物件關係不匹配)
         * [多對一和多對多的關係](./zh-tw/ch2.md#多對一和多對多的關係)
         * [文件資料庫是否在重蹈覆轍？](./zh-tw/ch2.md#文件資料庫是否在重蹈覆轍)
            * [網路模型](./zh-tw/ch2.md#網路模型)
            * [關係模型](./zh-tw/ch2.md#關係模型)
            * [與文件資料庫相比](./zh-tw/ch2.md#與文件資料庫相比)
         * [關係型資料庫與文件資料庫在今日的對比](./zh-tw/ch2.md#關係型資料庫與文件資料庫在今日的對比)
            * [哪個資料模型更方便寫程式碼？](./zh-tw/ch2.md#哪個資料模型更方便寫程式碼)
            * [文件模型中的架構靈活性](./zh-tw/ch2.md#文件模型中的架構靈活性)
            * [查詢的資料區域性](./zh-tw/ch2.md#查詢的資料區域性)
            * [文件和關係資料庫的融合](./zh-tw/ch2.md#文件和關係資料庫的融合)
      * [資料查詢語言](./zh-tw/ch2.md#資料查詢語言)
         * [Web上的宣告式查詢](./zh-tw/ch2.md#web上的宣告式查詢)
         * [MapReduce查詢](./zh-tw/ch2.md#mapreduce查詢)
      * [圖資料模型](./zh-tw/ch2.md#圖資料模型)
         * [屬性圖](./zh-tw/ch2.md#屬性圖)
         * [Cypher查詢語言](./zh-tw/ch2.md#cypher查詢語言)
         * [SQL中的圖查詢](./zh-tw/ch2.md#sql中的圖查詢)
         * [三元組儲存和SPARQL](./zh-tw/ch2.md#三元組儲存和sparql)
            * [語義網路](./zh-tw/ch2.md#語義網路)
            * [RDF資料模型](./zh-tw/ch2.md#rdf資料模型)
         * [SPARQL查詢語言](./zh-tw/ch2.md#sparql查詢語言)
            * [圖形資料庫與網路模型相比較](./zh-tw/ch2.md#圖形資料庫與網路模型相比較)
         * [基礎：Datalog](./zh-tw/ch2.md#基礎datalog)
      * [本章小結](./zh-tw/ch2.md#本章小結)
      * [參考文獻](./zh-tw/ch2.md#參考文獻)
