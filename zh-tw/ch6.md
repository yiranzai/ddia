<!--ts-->
   * [6. 分割槽](./zh-tw/ch6.md#6-分割槽)
               * [術語澄清](./zh-tw/ch6.md#術語澄清)
      * [分割槽與複製](./zh-tw/ch6.md#分割槽與複製)
      * [鍵值資料的分割槽](./zh-tw/ch6.md#鍵值資料的分割槽)
         * [根據鍵的範圍分割槽](./zh-tw/ch6.md#根據鍵的範圍分割槽)
         * [根據鍵的雜湊分割槽](./zh-tw/ch6.md#根據鍵的雜湊分割槽)
            * [一致性雜湊](./zh-tw/ch6.md#一致性雜湊)
         * [負載傾斜與消除熱點](./zh-tw/ch6.md#負載傾斜與消除熱點)
      * [分片與次級索引](./zh-tw/ch6.md#分片與次級索引)
         * [基於文件的二級索引進行分割槽](./zh-tw/ch6.md#基於文件的二級索引進行分割槽)
         * [基於關鍵詞(Term)的二級索引進行分割槽](./zh-tw/ch6.md#基於關鍵詞term的二級索引進行分割槽)
      * [分割槽再平衡](./zh-tw/ch6.md#分割槽再平衡)
         * [平衡策略](./zh-tw/ch6.md#平衡策略)
            * [反面教材：hash mod N](./zh-tw/ch6.md#反面教材hash-mod-n)
            * [固定數量的分割槽](./zh-tw/ch6.md#固定數量的分割槽)
            * [動態分割槽](./zh-tw/ch6.md#動態分割槽)
            * [按節點比例分割槽](./zh-tw/ch6.md#按節點比例分割槽)
         * [運維：手動還是自動平衡](./zh-tw/ch6.md#運維手動還是自動平衡)
      * [請求路由](./zh-tw/ch6.md#請求路由)
         * [執行並行查詢](./zh-tw/ch6.md#執行並行查詢)
      * [本章小結](./zh-tw/ch6.md#本章小結)
      * [參考文獻](./zh-tw/ch6.md#參考文獻)
