<!--ts-->
   * [7. 事務](./zh-tw/ch7.md#7-事務)
      * [事務的棘手概念](./zh-tw/ch7.md#事務的棘手概念)
         * [ACID的含義](./zh-tw/ch7.md#acid的含義)
            * [原子性（Atomicity）](./zh-tw/ch7.md#原子性atomicity)
            * [一致性（Consistency）](./zh-tw/ch7.md#一致性consistency)
            * [隔離性（Isolation）](./zh-tw/ch7.md#隔離性isolation)
            * [永續性（Durability）](./zh-tw/ch7.md#永續性durability)
            * [複製和永續性](./zh-tw/ch7.md#複製和永續性)
         * [單物件和多物件操作](./zh-tw/ch7.md#單物件和多物件操作)
            * [單物件寫入](./zh-tw/ch7.md#單物件寫入)
            * [多物件事務的需求](./zh-tw/ch7.md#多物件事務的需求)
            * [處理錯誤和中止](./zh-tw/ch7.md#處理錯誤和中止)
      * [弱隔離級別](./zh-tw/ch7.md#弱隔離級別)
         * [讀已提交](./zh-tw/ch7.md#讀已提交)
            * [沒有髒讀](./zh-tw/ch7.md#沒有髒讀)
            * [沒有髒寫](./zh-tw/ch7.md#沒有髒寫)
            * [實現讀已提交](./zh-tw/ch7.md#實現讀已提交)
         * [快照隔離和可重複讀](./zh-tw/ch7.md#快照隔離和可重複讀)
            * [實現快照隔離](./zh-tw/ch7.md#實現快照隔離)
            * [觀察一致性快照的可見性規則](./zh-tw/ch7.md#觀察一致性快照的可見性規則)
            * [索引和快照隔離](./zh-tw/ch7.md#索引和快照隔離)
            * [可重複讀與命名混淆](./zh-tw/ch7.md#可重複讀與命名混淆)
         * [防止丟失更新](./zh-tw/ch7.md#防止丟失更新)
            * [原子寫](./zh-tw/ch7.md#原子寫)
            * [顯式鎖定](./zh-tw/ch7.md#顯式鎖定)
            * [自動檢測丟失的更新](./zh-tw/ch7.md#自動檢測丟失的更新)
            * [比較並設定（CAS）](./zh-tw/ch7.md#比較並設定cas)
            * [衝突解決和複製](./zh-tw/ch7.md#衝突解決和複製)
            * [寫入偏差與幻讀](./zh-tw/ch7.md#寫入偏差與幻讀)
            * [寫偏差的特徵](./zh-tw/ch7.md#寫偏差的特徵)
            * [寫偏差的更多例子](./zh-tw/ch7.md#寫偏差的更多例子)
            * [導致寫入偏差的幻讀](./zh-tw/ch7.md#導致寫入偏差的幻讀)
            * [物化衝突](./zh-tw/ch7.md#物化衝突)
      * [可序列化](./zh-tw/ch7.md#可序列化)
            * [真的序列執行](./zh-tw/ch7.md#真的序列執行)
            * [在儲存過程中封裝事務](./zh-tw/ch7.md#在儲存過程中封裝事務)
            * [儲存過程的優點和缺點](./zh-tw/ch7.md#儲存過程的優點和缺點)
            * [分割槽](./zh-tw/ch7.md#分割槽)
            * [序列執行小結](./zh-tw/ch7.md#序列執行小結)
         * [兩階段鎖定（2PL）](./zh-tw/ch7.md#兩階段鎖定2pl)
            * [2PL不是2PC](./zh-tw/ch7.md#2pl不是2pc)
            * [實現兩階段鎖](./zh-tw/ch7.md#實現兩階段鎖)
            * [兩階段鎖定的效能](./zh-tw/ch7.md#兩階段鎖定的效能)
            * [謂詞鎖](./zh-tw/ch7.md#謂詞鎖)
            * [索引範圍鎖](./zh-tw/ch7.md#索引範圍鎖)
         * [序列化快照隔離（SSI）](./zh-tw/ch7.md#序列化快照隔離ssi)
            * [悲觀與樂觀的併發控制](./zh-tw/ch7.md#悲觀與樂觀的併發控制)
            * [基於過時前提的決策](./zh-tw/ch7.md#基於過時前提的決策)
            * [檢測舊MVCC讀取](./zh-tw/ch7.md#檢測舊mvcc讀取)
            * [檢測影響之前讀取的寫入](./zh-tw/ch7.md#檢測影響之前讀取的寫入)
            * [可序列化的快照隔離的效能](./zh-tw/ch7.md#可序列化的快照隔離的效能)
      * [本章小結](./zh-tw/ch7.md#本章小結)
      * [參考文獻](./zh-tw/ch7.md#參考文獻)

<!-- Added by: runner, at: Tue Apr 20 03:41:44 UTC 2021 -->
