<!--ts-->
   * [9. 一致性與共識](./zh-tw/ch9.md#9-一致性與共識)
      * [一致性保證](./zh-tw/ch9.md#一致性保證)
      * [線性一致性](./zh-tw/ch9.md#線性一致性)
         * [什麼使得系統線性一致？](./zh-tw/ch9.md#什麼使得系統線性一致)
         * [線性一致性與可序列化](./zh-tw/ch9.md#線性一致性與可序列化)
         * [依賴線性一致性](./zh-tw/ch9.md#依賴線性一致性)
            * [鎖定和領導選舉](./zh-tw/ch9.md#鎖定和領導選舉)
            * [約束和唯一性保證](./zh-tw/ch9.md#約束和唯一性保證)
            * [跨通道的時序依賴](./zh-tw/ch9.md#跨通道的時序依賴)
         * [實現線性一致的系統](./zh-tw/ch9.md#實現線性一致的系統)
            * [線性一致性和法定人數](./zh-tw/ch9.md#線性一致性和法定人數)
         * [線性一致性的代價](./zh-tw/ch9.md#線性一致性的代價)
            * [CAP定理](./zh-tw/ch9.md#cap定理)
         * [CAP定理沒有幫助](./zh-tw/ch9.md#cap定理沒有幫助)
            * [線性一致性和網路延遲](./zh-tw/ch9.md#線性一致性和網路延遲)
      * [順序保證](./zh-tw/ch9.md#順序保證)
         * [順序與因果](./zh-tw/ch9.md#順序與因果)
            * [因果順序不是全序的](./zh-tw/ch9.md#因果順序不是全序的)
            * [線性一致性強於因果一致性](./zh-tw/ch9.md#線性一致性強於因果一致性)
            * [捕獲因果關係](./zh-tw/ch9.md#捕獲因果關係)
         * [序列號順序](./zh-tw/ch9.md#序列號順序)
            * [非因果序列號生成器](./zh-tw/ch9.md#非因果序列號生成器)
            * [蘭伯特時間戳](./zh-tw/ch9.md#蘭伯特時間戳)
            * [光有時間戳排序還不夠](./zh-tw/ch9.md#光有時間戳排序還不夠)
         * [全序廣播](./zh-tw/ch9.md#全序廣播)
            * [順序保證的範圍](./zh-tw/ch9.md#順序保證的範圍)
            * [使用全序廣播](./zh-tw/ch9.md#使用全序廣播)
            * [使用全序廣播實現線性一致的儲存](./zh-tw/ch9.md#使用全序廣播實現線性一致的儲存)
            * [使用線性一致性儲存實現全序廣播](./zh-tw/ch9.md#使用線性一致性儲存實現全序廣播)
      * [分散式事務與共識](./zh-tw/ch9.md#分散式事務與共識)
         * [共識的不可能性](./zh-tw/ch9.md#共識的不可能性)
         * [原子提交與二階段提交（2PC）](./zh-tw/ch9.md#原子提交與二階段提交2pc)
            * [從單節點到分散式原子提交](./zh-tw/ch9.md#從單節點到分散式原子提交)
            * [兩階段提交簡介](./zh-tw/ch9.md#兩階段提交簡介)
            * [不要把2PC和2PL搞混了](./zh-tw/ch9.md#不要把2pc和2pl搞混了)
            * [系統承諾](./zh-tw/ch9.md#系統承諾)
            * [協調者失效](./zh-tw/ch9.md#協調者失效)
            * [三階段提交](./zh-tw/ch9.md#三階段提交)
         * [實踐中的分散式事務](./zh-tw/ch9.md#實踐中的分散式事務)
            * [恰好一次的訊息處理](./zh-tw/ch9.md#恰好一次的訊息處理)
            * [XA事務](./zh-tw/ch9.md#xa事務)
            * [懷疑時持有鎖](./zh-tw/ch9.md#懷疑時持有鎖)
            * [從協調者故障中恢復](./zh-tw/ch9.md#從協調者故障中恢復)
            * [分散式事務的限制](./zh-tw/ch9.md#分散式事務的限制)
         * [容錯共識](./zh-tw/ch9.md#容錯共識)
            * [共識演算法和全序廣播](./zh-tw/ch9.md#共識演算法和全序廣播)
            * [單領導者複製和共識](./zh-tw/ch9.md#單領導者複製和共識)
            * [時代編號和法定人數](./zh-tw/ch9.md#時代編號和法定人數)
            * [共識的侷限性](./zh-tw/ch9.md#共識的侷限性)
         * [成員與協調服務](./zh-tw/ch9.md#成員與協調服務)
            * [將工作分配給節點](./zh-tw/ch9.md#將工作分配給節點)
            * [服務發現](./zh-tw/ch9.md#服務發現)
            * [成員服務](./zh-tw/ch9.md#成員服務)
      * [本章小結](./zh-tw/ch9.md#本章小結)
      * [參考文獻](./zh-tw/ch9.md#參考文獻)

<!-- Added by: runner, at: Tue Apr 20 03:41:39 UTC 2021 -->
