<!--ts-->
   * [9. 一致性与共识](./ch9.md#9-一致性与共识)
      * [一致性保证](./ch9.md#一致性保证)
      * [线性一致性](./ch9.md#线性一致性)
         * [什么使得系统线性一致？](./ch9.md#什么使得系统线性一致)
         * [线性一致性与可序列化](./ch9.md#线性一致性与可序列化)
         * [依赖线性一致性](./ch9.md#依赖线性一致性)
            * [锁定和领导选举](./ch9.md#锁定和领导选举)
            * [约束和唯一性保证](./ch9.md#约束和唯一性保证)
            * [跨信道的时序依赖](./ch9.md#跨信道的时序依赖)
         * [实现线性一致的系统](./ch9.md#实现线性一致的系统)
            * [线性一致性和法定人数](./ch9.md#线性一致性和法定人数)
         * [线性一致性的代价](./ch9.md#线性一致性的代价)
            * [CAP定理](./ch9.md#cap定理)
         * [CAP定理没有帮助](./ch9.md#cap定理没有帮助)
            * [线性一致性和网络延迟](./ch9.md#线性一致性和网络延迟)
      * [顺序保证](./ch9.md#顺序保证)
         * [顺序与因果](./ch9.md#顺序与因果)
            * [因果顺序不是全序的](./ch9.md#因果顺序不是全序的)
            * [线性一致性强于因果一致性](./ch9.md#线性一致性强于因果一致性)
            * [捕获因果关系](./ch9.md#捕获因果关系)
         * [序列号顺序](./ch9.md#序列号顺序)
            * [非因果序列号生成器](./ch9.md#非因果序列号生成器)
            * [兰伯特时间戳](./ch9.md#兰伯特时间戳)
            * [光有时间戳排序还不够](./ch9.md#光有时间戳排序还不够)
         * [全序广播](./ch9.md#全序广播)
            * [顺序保证的范围](./ch9.md#顺序保证的范围)
            * [使用全序广播](./ch9.md#使用全序广播)
            * [使用全序广播实现线性一致的存储](./ch9.md#使用全序广播实现线性一致的存储)
            * [使用线性一致性存储实现全序广播](./ch9.md#使用线性一致性存储实现全序广播)
      * [分布式事务与共识](./ch9.md#分布式事务与共识)
         * [共识的不可能性](./ch9.md#共识的不可能性)
         * [原子提交与二阶段提交（2PC）](./ch9.md#原子提交与二阶段提交2pc)
            * [从单节点到分布式原子提交](./ch9.md#从单节点到分布式原子提交)
            * [两阶段提交简介](./ch9.md#两阶段提交简介)
            * [不要把2PC和2PL搞混了](./ch9.md#不要把2pc和2pl搞混了)
            * [系统承诺](./ch9.md#系统承诺)
            * [协调者失效](./ch9.md#协调者失效)
            * [三阶段提交](./ch9.md#三阶段提交)
         * [实践中的分布式事务](./ch9.md#实践中的分布式事务)
            * [恰好一次的消息处理](./ch9.md#恰好一次的消息处理)
            * [XA事务](./ch9.md#xa事务)
            * [怀疑时持有锁](./ch9.md#怀疑时持有锁)
            * [从协调者故障中恢复](./ch9.md#从协调者故障中恢复)
            * [分布式事务的限制](./ch9.md#分布式事务的限制)
         * [容错共识](./ch9.md#容错共识)
            * [共识算法和全序广播](./ch9.md#共识算法和全序广播)
            * [单领导者复制和共识](./ch9.md#单领导者复制和共识)
            * [时代编号和法定人数](./ch9.md#时代编号和法定人数)
            * [共识的局限性](./ch9.md#共识的局限性)
         * [成员与协调服务](./ch9.md#成员与协调服务)
            * [将工作分配给节点](./ch9.md#将工作分配给节点)
            * [服务发现](./ch9.md#服务发现)
            * [成员服务](./ch9.md#成员服务)
      * [本章小结](./ch9.md#本章小结)
      * [参考文献](./ch9.md#参考文献)
