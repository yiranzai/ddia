<!--ts-->
   * [2. 数据模型与查询语言](./ch2.md#2-数据模型与查询语言)
      * [关系模型与文档模型](./ch2.md#关系模型与文档模型)
         * [NoSQL的诞生](./ch2.md#nosql的诞生)
         * [对象关系不匹配](./ch2.md#对象关系不匹配)
         * [多对一和多对多的关系](./ch2.md#多对一和多对多的关系)
         * [文档数据库是否在重蹈覆辙？](./ch2.md#文档数据库是否在重蹈覆辙)
            * [网络模型](./ch2.md#网络模型)
            * [关系模型](./ch2.md#关系模型)
            * [与文档数据库相比](./ch2.md#与文档数据库相比)
         * [关系型数据库与文档数据库在今日的对比](./ch2.md#关系型数据库与文档数据库在今日的对比)
            * [哪种数据模型更有助于简化应用代码？](./ch2.md#哪种数据模型更有助于简化应用代码)
            * [文档模型中的架构灵活性](./ch2.md#文档模型中的架构灵活性)
            * [查询的数据局部性](./ch2.md#查询的数据局部性)
            * [文档和关系数据库的融合](./ch2.md#文档和关系数据库的融合)
      * [数据查询语言](./ch2.md#数据查询语言)
         * [Web上的声明式查询](./ch2.md#web上的声明式查询)
         * [MapReduce查询](./ch2.md#mapreduce查询)
      * [图数据模型](./ch2.md#图数据模型)
         * [属性图](./ch2.md#属性图)
         * [Cypher查询语言](./ch2.md#cypher查询语言)
         * [SQL中的图查询](./ch2.md#sql中的图查询)
         * [三元组存储和SPARQL](./ch2.md#三元组存储和sparql)
            * [语义网络](./ch2.md#语义网络)
            * [RDF数据模型](./ch2.md#rdf数据模型)
         * [SPARQL查询语言](./ch2.md#sparql查询语言)
            * [图形数据库与网络模型相比较](./ch2.md#图形数据库与网络模型相比较)
         * [基础：Datalog](./ch2.md#基础datalog)
      * [本章小结](./ch2.md#本章小结)
      * [参考文献](./ch2.md#参考文献)

<!-- Added by: runner, at: Tue Apr 20 03:41:54 UTC 2021 -->
