<!--ts-->
   * [第一章：可靠性，可伸缩性，可维护性](./ch1.md#第一章可靠性可伸缩性可维护性)
      * [关于数据系统的思考](./ch1.md#关于数据系统的思考)
      * [可靠性](./ch1.md#可靠性)
         * [硬件故障](./ch1.md#硬件故障)
         * [软件错误](./ch1.md#软件错误)
         * [人为错误](./ch1.md#人为错误)
         * [可靠性有多重要？](./ch1.md#可靠性有多重要)
      * [可伸缩性](./ch1.md#可伸缩性)
         * [描述负载](./ch1.md#描述负载)
         * [描述性能](./ch1.md#描述性能)
            * [延迟和响应时间](./ch1.md#延迟和响应时间)
            * [实践中的百分位点](./ch1.md#实践中的百分位点)
         * [应对负载的方法](./ch1.md#应对负载的方法)
      * [可维护性](./ch1.md#可维护性)
         * [可操作性：人生苦短，关爱运维](./ch1.md#可操作性人生苦短关爱运维)
         * [简单性：管理复杂度](./ch1.md#简单性管理复杂度)
         * [可演化性：拥抱变化](./ch1.md#可演化性拥抱变化)
      * [本章小结](./ch1.md#本章小结)
      * [参考文献](./ch1.md#参考文献)

<!-- Added by: runner, at: Tue Apr 20 03:41:33 UTC 2021 -->
