<!--ts-->
   * [4. 编码与演化](./ch4.md#4-编码与演化)
      * [编码数据的格式](./ch4.md#编码数据的格式)
            * [术语冲突](./ch4.md#术语冲突)
         * [语言特定的格式](./ch4.md#语言特定的格式)
         * [JSON，XML和二进制变体](./ch4.md#jsonxml和二进制变体)
            * [二进制编码](./ch4.md#二进制编码)
         * [Thrift与Protocol Buffers](./ch4.md#thrift与protocol-buffers)
            * [字段标签和模式演变](./ch4.md#字段标签和模式演变)
            * [数据类型和模式演变](./ch4.md#数据类型和模式演变)
         * [Avro](./ch4.md#avro)
            * [作者模式与读者模式](./ch4.md#作者模式与读者模式)
            * [模式演变规则](./ch4.md#模式演变规则)
               * [但作者模式到底是什么？](./ch4.md#但作者模式到底是什么)
            * [动态生成的模式](./ch4.md#动态生成的模式)
            * [代码生成和动态类型的语言](./ch4.md#代码生成和动态类型的语言)
         * [模式的优点](./ch4.md#模式的优点)
      * [数据流的类型](./ch4.md#数据流的类型)
         * [数据库中的数据流](./ch4.md#数据库中的数据流)
            * [在不同的时间写入不同的值](./ch4.md#在不同的时间写入不同的值)
            * [归档存储](./ch4.md#归档存储)
         * [服务中的数据流：REST与RPC](./ch4.md#服务中的数据流rest与rpc)
            * [Web服务](./ch4.md#web服务)
            * [远程过程调用（RPC）的问题](./ch4.md#远程过程调用rpc的问题)
            * [RPC的当前方向](./ch4.md#rpc的当前方向)
            * [数据编码与RPC的演化](./ch4.md#数据编码与rpc的演化)
         * [消息传递中的数据流](./ch4.md#消息传递中的数据流)
            * [消息代理](./ch4.md#消息代理)
            * [分布式的Actor框架](./ch4.md#分布式的actor框架)
      * [本章小结](./ch4.md#本章小结)
      * [参考文献](./ch4.md#参考文献)
