<!--ts-->
   * [7. 事务](./ch7.md#7-事务)
      * [事务的棘手概念](./ch7.md#事务的棘手概念)
         * [ACID的含义](./ch7.md#acid的含义)
            * [原子性（Atomicity）](./ch7.md#原子性atomicity)
            * [一致性（Consistency）](./ch7.md#一致性consistency)
            * [隔离性（Isolation）](./ch7.md#隔离性isolation)
            * [持久性（Durability）](./ch7.md#持久性durability)
            * [复制和持久性](./ch7.md#复制和持久性)
         * [单对象和多对象操作](./ch7.md#单对象和多对象操作)
            * [单对象写入](./ch7.md#单对象写入)
            * [多对象事务的需求](./ch7.md#多对象事务的需求)
            * [处理错误和中止](./ch7.md#处理错误和中止)
      * [弱隔离级别](./ch7.md#弱隔离级别)
         * [读已提交](./ch7.md#读已提交)
            * [没有脏读](./ch7.md#没有脏读)
            * [没有脏写](./ch7.md#没有脏写)
            * [实现读已提交](./ch7.md#实现读已提交)
         * [快照隔离和可重复读](./ch7.md#快照隔离和可重复读)
            * [实现快照隔离](./ch7.md#实现快照隔离)
            * [观察一致性快照的可见性规则](./ch7.md#观察一致性快照的可见性规则)
            * [索引和快照隔离](./ch7.md#索引和快照隔离)
            * [可重复读与命名混淆](./ch7.md#可重复读与命名混淆)
         * [防止丢失更新](./ch7.md#防止丢失更新)
            * [原子写](./ch7.md#原子写)
            * [显式锁定](./ch7.md#显式锁定)
            * [自动检测丢失的更新](./ch7.md#自动检测丢失的更新)
            * [比较并设置（CAS）](./ch7.md#比较并设置cas)
            * [冲突解决和复制](./ch7.md#冲突解决和复制)
            * [写入偏差与幻读](./ch7.md#写入偏差与幻读)
            * [写偏差的特征](./ch7.md#写偏差的特征)
            * [写偏差的更多例子](./ch7.md#写偏差的更多例子)
            * [导致写入偏差的幻读](./ch7.md#导致写入偏差的幻读)
            * [物化冲突](./ch7.md#物化冲突)
      * [可序列化](./ch7.md#可序列化)
            * [真的串行执行](./ch7.md#真的串行执行)
            * [在存储过程中封装事务](./ch7.md#在存储过程中封装事务)
            * [存储过程的优点和缺点](./ch7.md#存储过程的优点和缺点)
            * [分区](./ch7.md#分区)
            * [串行执行小结](./ch7.md#串行执行小结)
         * [两阶段锁定（2PL）](./ch7.md#两阶段锁定2pl)
            * [2PL不是2PC](./ch7.md#2pl不是2pc)
            * [实现两阶段锁](./ch7.md#实现两阶段锁)
            * [两阶段锁定的性能](./ch7.md#两阶段锁定的性能)
            * [谓词锁](./ch7.md#谓词锁)
            * [索引范围锁](./ch7.md#索引范围锁)
         * [序列化快照隔离（SSI）](./ch7.md#序列化快照隔离ssi)
            * [悲观与乐观的并发控制](./ch7.md#悲观与乐观的并发控制)
            * [基于过时前提的决策](./ch7.md#基于过时前提的决策)
            * [检测旧MVCC读取](./ch7.md#检测旧mvcc读取)
            * [检测影响之前读取的写入](./ch7.md#检测影响之前读取的写入)
            * [可序列化的快照隔离的性能](./ch7.md#可序列化的快照隔离的性能)
      * [本章小结](./ch7.md#本章小结)
      * [参考文献](./ch7.md#参考文献)

<!-- Added by: runner, at: Tue Apr 20 03:41:52 UTC 2021 -->
