<!--ts-->
   * [3. 存储与检索](./ch3.md#3-存储与检索)
      * [驱动数据库的数据结构](./ch3.md#驱动数据库的数据结构)
         * [哈希索引](./ch3.md#哈希索引)
         * [SSTables和LSM树](./ch3.md#sstables和lsm树)
               * [图3-4 合并几个SSTable段，只保留每个键的最新值](./ch3.md#图3-4-合并几个sstable段只保留每个键的最新值)
            * [构建和维护SSTables](./ch3.md#构建和维护sstables)
            * [用SSTables制作LSM树](./ch3.md#用sstables制作lsm树)
            * [性能优化](./ch3.md#性能优化)
         * [B树](./ch3.md#b树)
            * [让B树更可靠](./ch3.md#让b树更可靠)
            * [B树优化](./ch3.md#b树优化)
         * [比较B树和LSM树](./ch3.md#比较b树和lsm树)
            * [LSM树的优点](./ch3.md#lsm树的优点)
            * [LSM树的缺点](./ch3.md#lsm树的缺点)
         * [其他索引结构](./ch3.md#其他索引结构)
            * [将值存储在索引中](./ch3.md#将值存储在索引中)
            * [多列索引](./ch3.md#多列索引)
            * [全文搜索和模糊索引](./ch3.md#全文搜索和模糊索引)
            * [在内存中存储一切](./ch3.md#在内存中存储一切)
      * [事务处理还是分析？](./ch3.md#事务处理还是分析)
         * [数据仓库](./ch3.md#数据仓库)
            * [OLTP数据库和数据仓库之间的分歧](./ch3.md#oltp数据库和数据仓库之间的分歧)
         * [星型和雪花型：分析的模式](./ch3.md#星型和雪花型分析的模式)
      * [列存储](./ch3.md#列存储)
         * [列压缩](./ch3.md#列压缩)
            * [面向列的存储和列族](./ch3.md#面向列的存储和列族)
            * [内存带宽和向量处理](./ch3.md#内存带宽和向量处理)
         * [列存储中的排序顺序](./ch3.md#列存储中的排序顺序)
            * [几个不同的排序顺序](./ch3.md#几个不同的排序顺序)
         * [写入列存储](./ch3.md#写入列存储)
         * [聚合：数据立方体和物化视图](./ch3.md#聚合数据立方体和物化视图)
      * [本章小结](./ch3.md#本章小结)
      * [参考文献](./ch3.md#参考文献)

<!-- Added by: runner, at: Tue Apr 20 03:41:53 UTC 2021 -->
